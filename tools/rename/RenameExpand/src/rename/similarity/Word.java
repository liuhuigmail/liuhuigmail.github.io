...
// 	    
// 	   String[] splitOriginalName = Similarity.splitOriginalName(diffOut, oldNames);
// 	   for(int i = 0; i < splitOriginalName.length; i++){
// 		   System.out.println(splitOriginalName[i]+"00");
// 	   }
// 	  DataModel renameData = new DataModel();
// 	 renameData.originalName="getSafeInstanceData";
// 	renameData.subsequentName = "getSaveInstanceData";
// 	String candidateName = "setSafeInstanceData";
// 	  Similarity.calculateSim(renameData, candidateName);
